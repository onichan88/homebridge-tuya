...
class SimpleFanLightAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        if (this.device.context.name == 'VentEric')
	{
		this.dpActive = this._getCustomDP(this.device.context.dpActive) || '1';
        	...
        	//this.dpRotationDirection = this._getCustomDP(this.device.context.RotationDirection) || '63';
		//console.log(this.dpDirection);
		//console.log(this._getCustomDP(this.device.context.Direction) || '63');
	...
	const characteristicRotationDirection = serviceFan.getCharacteristic(Characteristic.RotationDirection)
		...
		minValue: 0,
            ...
            .updateValue(this._getDirection(dps[this.dpRotationDirection]))
	...
	//let characteristicColorTemperature;
        ...
        this.device.on('change', (changes, state) => {
            ...
            if (changes.hasOwnProperty(this.dpRotationSpeed) && characteristicRotationSpeed.value !== changes[this.dpRotationSpeed]) {
                //console.log(this.dpRotationSpeed);
		//console.log(characteristicRotationSpeed.value);
		//console.log(changes[this.dpRotationSpeed]);
...
// Fan Direction
    ...
    _getDirection(dp) {
        const {Characteristic} = this.hap;
		//console.log("_getDirection = " + dp);
	    if (dp == 'forward') { dp='0';} else { dp='1';}
        return dp;
    }
...
// Lightbulb State
 ...
 // Lightbulb Brightness
    ...
    setBrightness(value, callback) {
        ...
        return this.setState((this.dpBrightness) * 10, value, callback);
        callback();
    }
